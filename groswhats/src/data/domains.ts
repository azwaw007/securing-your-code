...
const LEGACY_DOMAINS: ShopDomain[] = [
  ...
  /** Apps sport séparées → unifiées dans « Salle de sport » (disciplines admin). */
  d('svc-boxe', 'services', '🥊', 'Club de boxe (ancien)', 'ملاكمة (قديم)', 'sport-boxe', SVC),
  d('svc-football', 'services', '⚽', 'Football (ancien)', 'كرة قدم (قديم)', 'sport-foot', SVC),
  d('svc-yoga', 'services', '🧘', 'Yoga (ancien)', 'يوغا (قديم)', 'sport-yoga', SVC),
  d('svc-crossfit', 'services', '🔥', 'CrossFit (ancien)', 'كروس فت (قديم)', 'sport-crossfit', SVC),
  d(
    'svc-arts-martiaux',
    'services',
    '🥋',
    'Arts martiaux (ancien)',
    'فنون قتالية (قديم)',
    'sport-martial',
    SVC,
  ),
  d('svc-natation', 'services', '🏊', 'Natation (ancien)', 'سباحة (قديم)', 'sport-swim', SVC),
  d('svc-tennis', 'services', '🎾', 'Tennis (ancien)', 'تنس (قديم)', 'sport-tennis', SVC),
  d('svc-danse', 'services', '💃', 'Danse (ancien)', 'رقص (قديم)', 'sport-danse', SVC),
  d(
    'svc-musculation',
    'services',
    '💪',
