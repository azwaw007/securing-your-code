...
const CATALOGS: Record<string, SeedSpec[]> = {
  ...
  'jeux-ps': [
    s('Heure XBOX ONE', 200, 0, '🟩', 'autre'),
    s('Match XBOX ONE', 50, 0, '🟩', 'autre'),
    s('Heure PS4', 200, 0, '🎮', 'autre'),
    s('Match PS4', 50, 0, '⚽', 'autre'),
    s('Heure PS4 PRO', 250, 0, '🎮', 'autre'),
    s('Match PS4 PRO', 70, 0, '⚽', 'autre'),
    s('Heure PS5', 300, 0, '🕹️', 'autre'),
    s('Match PS5', 100, 0, '🏆', 'autre'),
    s('Heure XBOX 360', 100, 0, '⬜', 'autre'),
    ...
    s('Manette supplémentaire / h', 100, 0, '🎛️', 'autre'),
    s('Eau 50 cl', 50, 25, '💧', 'alimentaire'),
    s('Boisson 33 cl', 120, 70, '🧃', 'alimentaire'),
    s('Snack / chips', 150, 80, '🍟', 'alimentaire'),
    s('Réparation manette', 1500, 200, '🔧', 'autre'),
    s('Réparation console / diag', 3000, 400, '🛠️', 'autre'),
  ],
  fete: [
