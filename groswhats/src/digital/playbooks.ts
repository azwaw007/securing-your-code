...
export const ADS_CHANNELS: AdsChannelGuide[] = [
  ...
  },
  {
    ...
    stepsFr: [
      ...
      'Pages utiles : guides POS, stock, fiscalité DZ',
      'Combiner AdSense + vente AZ POS en CTA',
    ],
    stepsAr: [
      'موقع بمحتوى أصلي · HTTPS',
      'طلب AdSense · احترام السياسات',
      'صفحات مفيدة: أدلة الصندوق والمخزون',
      'ادمج AdSense مع زر شراء AZ POS',
    ],
...
export const WINNING_IDEAS: WinningIdea[] = [
  {
    id: 'pos-soft',
    nicheFr: 'Logiciel caisse / stock (AZ POS)',
    nicheAr: 'برنامج صندوق / مخزون (AZ POS)',
    type: 'digital',
    score: 92,
    ...
    strategyFr: [
      ...
      'Ads Meta messages + organique groupes commerçants',
      'Upsell Pro multi-postes',
    ],
    strategyAr: [
      'تجربة مجانية 14 يوماً',
      'إعلانات رسائل + مجموعات تجار',
  ...
  },
  {
    ...
    type: 'physical',
    score: 85,
    whyFr: 'Besoin récurrent + AZ POS comme upsell',
    whyAr: 'حاجة متكررة + AZ POS كترقية',
  ...
  {
    id: 'formation',
    nicheFr: 'Formation en ligne compta / stock',
    nicheAr: 'دورة أونلاين محاسبة / مخزون',
    type: 'digital',
    score: 74,
    whyFr: 'Contenu réutilisable + AdSense + vente AZ POS',
    whyAr: 'محتوى يُعاد بيعه + أدسنس + AZ POS',
