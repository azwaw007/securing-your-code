...
const PACKS: Record<MetierFamily, MetierPack> = {
  ...
  football: pack(
    ...
    { ...FEAT.service, gymCheckin: true, homeScan: true, specialtyDossier: false },
    {
      ...
      product: 'Boutique',
      sell: 'Encaisser',
      sellHint: 'Boutique, licence, cotisation',
      homeTitle: 'Football',
      homeHint: 'Joueurs, boutique et check-in',
    ...
    },
    {
      ...
      product: 'متجر',
      sell: 'تحصيل',
      sellHint: 'متجر، رخصة، اشتراك',
      homeTitle: 'كرة القدم',
      homeHint: 'لاعبون ومتجر ودخول',
      historyLabel: 'الاشتراكات',
      primaryCta: 'دخول / تحصيل',
    },
  ),
  yoga: pack(
    ...
    { ...FEAT.service, gymCheckin: true, homeScan: true, specialtyDossier: false },
    {
      ...
      product: 'Boutique',
      sell: 'Encaisser',
      sellHint: 'Boutique, cours, forfaits',
      homeTitle: 'Yoga',
      homeHint: 'Élèves, boutique et séances',
      historyLabel: 'Abonnements',
      primaryCta: 'Check-in / encaisser',
    },
    {
      ...
      product: 'متجر',
      sell: 'تحصيل',
      sellHint: 'متجر، حصص، باقات',
      homeTitle: 'يوغا',
      homeHint: 'تلاميذ ومتجر وحصص',
      historyLabel: 'الاشتراكات',
      primaryCta: 'دخول / تحصيل',
    },
  ),
  crossfit: pack(
    ...
    { ...FEAT.service, gymCheckin: true, homeScan: true, specialtyDossier: false },
    {
      ...
      product: 'Boutique',
      sell: 'Encaisser',
      sellHint: 'Boutique, WOD, check-in',
      homeTitle: 'CrossFit',
      homeHint: 'Athlètes, boutique et accès',
      historyLabel: 'Abonnements',
      primaryCta: 'Check-in / encaisser',
    },
    {
  ...
  martial: pack(
    ...
    { ...FEAT.service, gymCheckin: true, homeScan: true, specialtyDossier: false },
    {
      ...
      product: 'Boutique',
      sell: 'Encaisser',
      sellHint: 'Boutique, grades, check-in',
      homeTitle: 'Arts martiaux',
      homeHint: 'Pratiquants, boutique et dojo',
      historyLabel: 'Abonnements',
      primaryCta: 'Check-in / encaisser',
    },
    {
      ...
      product: 'متجر',
      sell: 'تحصيل',
      sellHint: 'متجر، درجات، دخول',
      homeTitle: 'فنون قتالية',
      homeHint: 'ممارسون ومتجر ودخول',
      historyLabel: 'الاشتراكات',
      primaryCta: 'دخول / تحصيل',
    },
  ),
  swim: pack(
    ...
    { ...FEAT.service, gymCheckin: true, homeScan: true, specialtyDossier: false },
    {
      ...
      product: 'Boutique',
      sell: 'Encaisser',
      sellHint: 'Boutique, forfaits, accès bassin',
      homeTitle: 'Natation',
      homeHint: 'Nageurs, boutique et check-in',
      historyLabel: 'Abonnements',
      primaryCta: 'Check-in / encaisser',
    },
    {
      ...
      product: 'متجر',
      sell: 'تحصيل',
      sellHint: 'متجر، باقات، دخول المسبح',
      homeTitle: 'السباحة',
      homeHint: 'سباحون ومتجر ودخول',
      historyLabel: 'الاشتراكات',
      primaryCta: 'دخول / تحصيل',
    },
  ),
  tennis: pack(
    ...
    { ...FEAT.service, gymCheckin: true, homeScan: true, specialtyDossier: false },
    {
      ...
      product: 'Boutique',
      sell: 'Encaisser',
      sellHint: 'Boutique, réservation court',
      homeTitle: 'Tennis',
      homeHint: 'Joueurs, boutique et courts',
      historyLabel: 'Abonnements',
      primaryCta: 'Check-in / encaisser',
    },
    {
      ...
      product: 'متجر',
      sell: 'تحصيل',
      sellHint: 'متجر، حجز ملعب',
      homeTitle: 'التنس',
      homeHint: 'لاعبون ومتجر وملاعب',
      historyLabel: 'الاشتراكات',
      primaryCta: 'دخول / تحصيل',
    },
  ),
  ...
  musculation: pack(
    ...
    { ...FEAT.service, gymCheckin: true, homeScan: true, specialtyDossier: false },
    {
      ...
      product: 'Boutique',
      sell: 'Encaisser',
      sellHint: 'Boutique, musculation, check-in',
      homeTitle: 'Musculation',
      homeHint: 'Adhérents, boutique et accès salle',
      historyLabel: 'Abonnements',
      primaryCta: 'Check-in / encaisser',
    },
    {
      ...
      product: 'متجر',
      sell: 'تحصيل',
      sellHint: 'متجر، كمال أجسام، دخول',
      homeTitle: 'كمال الأجسام',
      homeHint: 'منخرطون ومتجر ودخول القاعة',
      historyLabel: 'الاشتراكات',
      primaryCta: 'دخول / تحصيل',
    },
  ),
  ...
  game_room: pack(
    ...
    },
    {
      ...
      product: 'Temps PS',
      sell: 'Encaisser',
      sellHint: 'Heures PlayStation, boissons',
      homeTitle: 'Salle de jeux',
      homeHint: '15 postes PS — temps et TV Wi‑Fi',
      historyLabel: 'Sessions',
      primaryCta: 'Nouvelle session',
    },
    {
      client: 'لاعب',
      product: 'وقت PS',
      sell: 'تحصيل',
      sellHint: 'ساعات بلاي ستيشن، مشروبات',
      homeTitle: 'قاعة الألعاب',
      homeHint: '15 جهاز PS — الوقت والتلفزيون',
...
export function metierVocab(
  ...
  const effectiveMode =
    mode || domainById(domainId || '')?.mode || ('gros' as CommerceMode)
  /**
   * Gros / détail : Stock ou Rayon (vocab métier).
