...
| **Télécharger Windows (.exe)** | https://github.com/azwaw007/securing-your-code/releases/download/v1.0.0-win/AZ-POS-Setup-1.0.0.exe |
...
| **Release GitHub** | https://github.com/azwaw007/securing-your-code/releases/tag/v1.0.0-win |

Ouvre aussi **`liens.html`** dans ce dossier (clics directs).
...
## 3. Message court pour Stories / WhatsApp
